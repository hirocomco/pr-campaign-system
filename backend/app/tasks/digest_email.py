...
<body>
    <div class="container">
        ...
        <h2>🔥 Top Trending Opportunities</h2>
        ...
        <div class="trend-card">
            ...
            <div class="trend-meta">
                ...
                🎯 {{ "%.0f"|format(trend.pr_potential_score or 0) }}% PR Potential |
                ⚡ {{ "%.0f"|format(trend.viral_potential_score or 0) }}% Viral Potential
            </div>
            <p>{{ trend.description }}</p>
            
            {% if trend.top_campaign %}
            <div class="campaign-preview">
                <strong>💡 Campaign Idea:</strong> {{ trend.top_campaign.title }}
